...
# ==========================================
# 5. 仅执行论文最终方法：LoRA-BIRM Snapshot
# ==========================================
MAX_STEPS = 600 
results = {}
...
# ==========================================
print("\n" + "="*80)
print("🏆 论文最终方法结果汇总 (对抗环境 + LoRA-BIRM Snapshot + 全量评测) 🏆")
print("="*80)
...
pd.DataFrame(
    [
        {
            "method": "LoRA-BIRM Snapshot (Ours)",
            "runtime_min": results['LoRA-BIRM Snapshot (Ours)'][0],
            "reversed_test_acc": results['LoRA-BIRM Snapshot (Ours)'][1],
        }
    ]
).to_csv("/root/qwen_lora_birm_only_results.csv", index=False)
print("📄 已保存: /root/qwen_lora_birm_only_results.csv")
